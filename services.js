angular.module('myApp.services', ['ngRoute'])
    .factory('Images', [function () {
        return [
            ...
            {id: "illustration", title: "Illustrations", subtitle: "", thumbnail: "illustration-preview.jpg"}
        ];
    }])
    .factory('Data', [function () {
        return [
            ...
            },
            {
                id: "fluxify",
                title: "Fluxify",
                description: "The goal of this project was to take an existing textbook and create a digital version of it. The textbook I chose was a cosmetology textbook. The main goal of Fluxify is to enable students to be able to access the scientific information pertaining to cosmetology, but to also connect them with external resources. Cosmetology is a subject that is interactive, hands on and ever-changing. Fluxify take the information of a traditional textbook and enhances it with real-world, interactive content.",
                date: "Spring 2016",
                collaborators: ""
            },
            {
